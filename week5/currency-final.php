...
<head>
<meta charset="UTF-8">
<title> Final Currency Form</title>
<style>
    form{
        width: 350px;
        margin: 0 auto;
...
echo 'selected="selected"';
            ...
            <ul>
<!-- Logic = we are still asking if currency isset  but now we are asking one more question--- is hte post currency equal to the value-->
